	...
	<nav>
		<div class="nav nav-tabs" id="nav-tab" role="tablist">
			<a class="nav-item nav-link active" id="nav-home-tab"
				...
				aria-selected="false">캘린더</a> <a class="nav-item nav-link"
			...
			<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab"
				...
				aria-selected="false">회계</a> <a class="nav-item nav-link"
				id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
				role="tab" aria-controls="nav-contact" aria-selected="false">사진첩</a>
			<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab"
				href="#nav-contact" role="tab" aria-controls="nav-contact"
				aria-selected="false">회의</a> <a class="nav-item nav-link"
				id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
