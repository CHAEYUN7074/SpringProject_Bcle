...
<body>
	...
	<section class="main">
		...
		<div class="upper">
			...
			</select> 모임명<input type="text"> 주최자 : 글작성자닉네임
		</div>
		<div class="bottom">
			<div class="intro">
				<h3>모임소개</h3>
...
<div class="bottom2">
		<div class="left">
			...
			<br></br> 참가비 <input type="text"> <br> 모임일 <input
				type="date"> <br> 모임시간<input type="time"><br>
			모임장소<input type="text"><br> 인원<input type="number"
				id=min> - <input type="number" id=max><br>
